      ...
      <div class="mb-8 space-y-4"></div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow">
          ...
          <div class="field-wrapper flex flex-col border-b border-gray-100 dark:border-gray-700 md:flex-row" index="0">
            ...
            <div class="md:mt-0 px-6 md:px-8 w-full md:w-3/5 md:py-5">
              <input type="text" placeholder="Enter Inconsistency Treatment" v-model="compliance.inconsistencyTreatment" class="w-full form-control form-input form-input-bordered" id="name-create-inconsistencyTreatment-text-field" name="inconsistencyTreatment" dusk="inconsistencyTreatment"  required="required" pattern="^[a-zA-Z0-9 ]+$"><!----><!----><!---->
            </div>
          </div>
